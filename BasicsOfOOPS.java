public class BasicsOfOOPS {
    ...
    //PC registers : address of next instruction should be executed
    //native method area : code of other languages which was required by java will be available here

    //When we are using the new keyword it is signal to the jvm to create some space to the object
    //After this the "hashCode" will be give and will collect by the reference variable
